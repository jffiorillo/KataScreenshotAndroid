...
public class SuperHeroesRepository {
  ...
  private void fillRepositoryWithFakeData() {
    superHeroes.add(new SuperHeroBuilder().setName("Scarlet Witch")
        .setPhoto("https://i.annihil.us/u/prod/marvel/i/mg/9/b0/537bc2375dfb9.jpg")
        .setIsAvenger(false)
        .setDescription("Scarlet Witch was born at the Wundagore base of the High Evolutionary, she and her twin "
        ...
        .createSuperHero());
    superHeroes.add(
        new SuperHeroBuilder().setName("Iron Man")
            .setPhoto("https://i.annihil.us/u/prod/marvel/i/mg/c/60/55b6a28ef24fa.jpg")
            .setIsAvenger(true)
            .setDescription("Wounded, captured and forced to build a weapon by his enemies, billionaire "
            ...
            .createSuperHero());
    superHeroes.add(
        new SuperHeroBuilder().setName("Wolverine")
            .setPhoto("https://i.annihil.us/u/prod/marvel/i/mg/9/00/537bcb1133fd7.jpg")
            .setIsAvenger(false)
            .setDescription("Born with super-human senses and the power to heal from almost any wound, Wolverine "
            ...
            .createSuperHero());
    superHeroes.add(
        new SuperHeroBuilder().setName("Hulk")
            .setPhoto("https://x.annihil.us/u/prod/marvel/i/mg/e/e0/537bafa34baa9.jpg")
            .setIsAvenger(true)
            .setDescription("Caught in a gamma bomb explosion while trying to save the life of a teenager, Dr. "
            ...
            .createSuperHero());
    superHeroes.add(
        new SuperHeroBuilder().setName("Storm")
            .setPhoto("https://x.annihil.us/u/prod/marvel/i/mg/c/b0/537bc5f8a8df0.jpg")
            .setIsAvenger(false)
            .setDescription("Ororo Monroe is the descendant of an ancient line of African priestesses, all of whom"
                + " have white hair, blue eyes, and the potential to wield magic.")
            .createSuperHero());
    superHeroes.add(new SuperHeroBuilder().setName("Spider-Man")
        .setPhoto("https://x.annihil.us/u/prod/marvel/i/mg/6/60/538cd3628a05e.jpg")
        .setIsAvenger(true)
        .setDescription("Bitten by a radioactive spider, high school student Peter Parker gained the speed, "
        ...
        .createSuperHero());
    superHeroes.add(
        new SuperHeroBuilder().setName("Ultron")
            .setPhoto("https://i.annihil.us/u/prod/marvel/i/mg/9/a0/537bc7f6d5d23.jpg")
            .setIsAvenger(false)
            .setDescription("Arguably the greatest and certainly the most horrific creation of scientific genius "
                + "Dr. Henry Pym, Ultron is a criminally insane rogue sentient robot dedicated to"
                + " conquest and the extermination of humanity.")
            .createSuperHero());
    superHeroes.add(new SuperHeroBuilder().setName("BlackPanther")
        .setPhoto("https://i.annihil.us/u/prod/marvel/i/mg/9/03/537ba26276348.jpg")
        .setIsAvenger(false)
        .setDescription(" T'Challa is a brilliant tactician, strategist, scientist, tracker and a master of all "
            ...
            + "of Wakanda.")
        .createSuperHero());
    superHeroes.add(new SuperHeroBuilder().setName("Captain America")
        .setPhoto("http://x.annihil.us/u/prod/marvel/i/mg/9/80/537ba5b368b7d.jpg")
        .setIsAvenger(true)
        .setDescription("Captain America represented the pinnacle of human physical perfection. He experienced a "
        ...
        .createSuperHero());
    superHeroes.add(new SuperHeroBuilder().setName("Winter Soldier")
        .setPhoto("https://i.annihil.us/u/prod/marvel/i/mg/7/40/537bca868687c.jpg")
        .setIsAvenger(false)
        .setDescription("Olympic-class athlete and exceptional acrobat highly skilled in both unarmed and armed "
            + "hand-to-hand combat and extremely accurate marksman. he is fluent in four languages "
            + "including German and Russian.")
        .createSuperHero());
    superHeroes.add(new SuperHeroBuilder().setName("Captain Marvel")
        .setPhoto("https://x.annihil.us/u/prod/marvel/i/mg/6/30/537ba61b764b4.jpg")
        .setIsAvenger(false)
        .setDescription(" Ms. Marvel's current powers include flight, enhanced strength, durability and the "
            + "ability to shoot concussive energy bursts from her hands.")
        .createSuperHero());
    superHeroes.add(
        new SuperHeroBuilder().setName("Iron Fist")
            .setPhoto("https://i.annihil.us/u/prod/marvel/i/mg/6/60/537bb1756cd26.jpg")
            .setIsAvenger(false)
            .setDescription("Through concentration, Iron Fist can harness his spiritual energy, or chi, to augment "
